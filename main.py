					...
					if isCloseMill(pos, board):
						...
						while not itemPlaced:
							try:
								...
								print(" L'entrée était hors limites ou n'était pas un nombre entier")
...
if __name__ == "__main__":
	...
	print("Bienvenue à Jeu de Moulin")
	print("1. Humaine Vs Ordinateur")
	print("2.Ordinateur Vs Ordinateur")
	gametype = input("Entrez s'il vous plait 1 ou 2: ")
